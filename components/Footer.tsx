      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-stone-900 uppercase dark:text-white">
                Resources
              </h2>
        ...
        <div className="text-stone-100 flex flex-col py-6 lg:flex-row items-center justify-between">
          ...
          <Link
            className="text-sm flex gap-2  sm:text-center hover:text-violet-600 hover:font-semibold"
